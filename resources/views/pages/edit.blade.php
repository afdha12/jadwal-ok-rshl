                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control text-uppercase" id="jam_operasi" name="jam_operasi2"
                    ...
                    <div class="col-sm-8">
                        <select name="ruang_operasi" class="form-control">
                            @foreach ($optionKamar as $ruang_operasi)
                                <option value="{{ $ruang_operasi }}" @if ($ruang_operasi == $data->ruang_operasi) selected @endif>
