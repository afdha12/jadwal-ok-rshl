                ...
                <div class="card-body m-2">
                    <form action="{{ route('schedule.store') }}" method="POST">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                <input type="date" class="form-control text-uppercase" id="tgl_operasi" name="tgl_operasi">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="colFormLabel" class="col-sm-3 col-form-label">Jam Operasi</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control text-uppercase" id="jam_operasi" name="jam_operasi">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="colFormLabel" class="col-sm-3 col-form-label">Nama Pasien</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control text-uppercase" id="nama_pasien" name="nama_pasien">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="colFormLabel" class="col-sm-3 col-form-label">Usia</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control text-uppercase" id="usia" name="usia">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="colFormLabel" class="col-sm-3 col-form-label">No. CM</label>
                            <div class="col-sm-8">
                                <input type="number" class="form-control text-uppercase" id="no_cm" name="no_cm">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="colFormLabel" class="col-sm-3 col-form-label">Diagnosa</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control text-uppercase" id="diagnosa" name="diagnosa">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="colFormLabel" class="col-sm-3 col-form-label">Tindakan</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control text-uppercase" id="tindakan" name="tindakan">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="colFormLabel" class="col-sm-3 col-form-label">Operator</label>
                            <div class="col-sm-8">
                                {{-- <input type="text" class="form-control text-uppercase" id="operator" name="operator"> --}}
                                <select name="operator" class="form-control text-uppercase">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                <select name="ruang_operasi" class="form-control text-uppercase">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control text-uppercase" id="jaminan" name="jaminan">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="colFormLabel" class="col-sm-3 col-form-label">Profilaksis</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control text-uppercase" id="profilaksis" name="profilaksis">
                            </div>
                        </div>
                        <div class="row mb-4">
